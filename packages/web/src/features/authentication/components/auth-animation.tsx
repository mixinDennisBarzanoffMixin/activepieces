...
function FlowNode(_props: {
  ...
  const props = mergeProps(
    { borderColor: 'border-gray-200', iconBg: 'bg-gray-50' },
    _props,
  );
  return (
    <div
      class={cn('rounded-xl border bg-white px-3 py-2.5', props.borderColor)}
    >
      <div class="flex items-center gap-2.5">
        ...
        <div class="flex-1 min-w-0">
          <div class="font-medium text-gray-900 text-sm truncate leading-tight">
            {props.label}
          </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          class="bg-white rounded-[10px] overflow-hidden h-full"
          style={{
            transition: 'opacity 300ms ease, visibility 300ms ease',
            'transition-delay': isCollapsed() ? '0ms' : '200ms',
        ...
        >
          ...
          <div
            ...
            style={{
              'max-height':
                props.activeIndex === 0 || props.activeIndex === 1
                  ? '400px'
                  : '0px',
              opacity:
                props.activeIndex === 0 || props.activeIndex === 1 ? 1 : 0,
            }}
          >
            <div class="p-4 space-y-3">
              {/* Instructions */}
              <div>
                <label class="text-xs font-bold text-gray-400 uppercase mb-1.5 block">
                  Instructions
                </label>
                <Show
                  when={showInstructions()}
                  fallback={
                    <div class="p-3 rounded-lg bg-gray-100 border border-gray-200 min-h-[60px] space-y-2">
                  ...
                  <div class="p-3 rounded-lg bg-violet-50 border border-violet-200 min-h-[60px]">
                    <p class="text-sm text-gray-700 leading-relaxed">
                      ...
                      <Show when={props.isTyping}>
                        <span class="inline-block w-0.5 h-4 bg-violet-500 ml-0.5 animate-pulse" />
                      </Show>
                    </p>
                  </div>
                </Show>
              ...
              <div class="grid grid-cols-2 gap-2">
                ...
                <div class="p-3 rounded-lg bg-gray-50 border border-gray-100">
                  ...
                  <Show
                    ...
                    fallback={
                      <div class="flex items-center gap-2.5">
                        <div class="w-7 h-7 rounded-md bg-gray-200 flex-shrink-0" />
        ...
        <div
          class="absolute inset-[2px] rounded-[10px] bg-gradient-to-br from-violet-100 to-fuchsia-100 flex items-center justify-center text-sm"
          style={{
            transition: 'opacity 300ms ease, visibility 300ms ease',
            'transition-delay': isCollapsed() ? '200ms' : '0ms',
...
function Scene0Slot(props: { slotRef: (el: HTMLDivElement) => void }) {
  return (
    <div class="absolute inset-0 flex items-center justify-center p-8">
      <div ref={props.slotRef} class="w-[340px] h-[320px]" />
    </div>
  );
}
  ...
  return (
    ...
    >
      <div class="flex items-start">
        {/* Agent slot */}
        <div ref={props.slotRef} class="w-[340px] h-[320px] relative mt-12" />
        ...
        <div class="w-64 -ml-16 relative z-50">
          ...
          <div class="p-3 border-x border-gray-200 bg-white relative">
            <div class="grid grid-cols-4 gap-2">
              <For each={INTEGRATION_LOGOS}>
                {(app) => (
                  <div class="group/icon relative w-12 h-12 rounded-lg bg-white border border-gray-200 p-2 hover:border-violet-400 hover:scale-105 hover:bg-violet-50 transition-all duration-150 cursor-pointer flex items-center justify-center hover:z-[100]">
                    <img
                      src={`${CDN}/${app.slug}.png`}
                      alt={app.name}
                      class="w-7 h-7 object-contain pointer-events-none"
                    />
                    <span class="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 px-2 py-1 bg-gray-900 text-white text-xs rounded whitespace-nowrap opacity-0 invisible group-hover/icon:opacity-100 group-hover/icon:visible transition-all duration-150 z-[200]">
                      {app.name}
                    </span>
                  </div>
                )}
          ...
          <div class="px-4 py-3 bg-gray-50 border border-gray-200 border-t-gray-100 rounded-b-xl flex items-center justify-between">
            <p class="text-gray-900 font-semibold">685+ apps</p>
  ...
  return (
    ...
    >
      <div class="relative" style={{ width: '390px', height: '400px' }}>
        ...
        >
          <div class="absolute -top-5 left-0 text-xs font-medium text-green-600 bg-green-50 px-2 py-0.5 rounded border border-green-200 z-10">
            {'⚡'} Trigger
          </div>
          <FlowNode
            icon={
        ...
        >
          <FlowNode
            icon={
              <img src={`${CDN}/slack.png`} class="w-[19px] h-[19px]" alt="" />
            }
        ...
        >
          <FlowNode
            icon={
              <img src={`${CDN}/gmail.png`} class="w-[19px] h-[19px]" alt="" />
            }
            label="7. Send Email"
            subtitle="Gmail"
            iconBg="bg-cyan-50"
        ...
        <div class="bg-white rounded-lg overflow-hidden border border-gray-200">
          ...
          <div class="p-4">
            <div class="flex gap-3">
              ...
              <div ref={props.slotRef} class="w-8 h-8 flex-shrink-0 mt-0.5" />
...
function Scene4(props: {
  ...
  return (
    <div
      class="absolute inset-0 flex flex-col items-center justify-end"
      style={{
        transition: 'opacity 500ms ease',
        opacity: props.visible ? 1 : 0,
        'pointer-events': props.visible ? 'auto' : 'none',
    ...
    >
      {/* TOP: Agent card */}
      <div class="relative flex-shrink-0 mt-32">
        <div ref={props.slotRef} class="w-[200px] h-[60px]" />
      </div>

      {/* Vertical lines */}
      <div class="relative w-[30px] h-[60px] flex-shrink-0 z-0">
        ...
        <div class="absolute inset-0 pointer-events-none">
          <For each={[0, 0.5, 1, 1.5]}>
            {(delay) => (
              <span
                class="auth-anim-particle-dot-vertical bg-emerald-500"
                style={{ left: '8px', 'animation-delay': `${delay}s` }}
              />
            )}
          </For>
          <For each={[0, 0.5, 1, 1.5]}>
            {(delay) => (
              <span
                class="auth-anim-particle-dot-vertical-reverse bg-violet-500"
                style={{ left: '18px', 'animation-delay': `${delay}s` }}
              />
            )}
          </For>
        </div>
      ...
      <div class="bg-white border border-gray-200 border-b-0 rounded-t-xl flex flex-col overflow-hidden w-[90%] z-10">
        {/* Toolbar */}
        ...
        <div class="flex-1 overflow-auto">
          <table class="w-full border-collapse text-sm">
            <thead class="sticky top-0 z-10">
              <tr class="bg-gray-50">
                <th class="w-10 px-3 py-2 text-center text-xs font-medium text-gray-400 border-b border-r border-gray-200 bg-gray-50" />
                <th class="px-4 py-2 text-left text-xs font-semibold text-gray-600 border-b border-r border-gray-200 bg-gray-50">
                  Name
                </th>
                <th class="px-4 py-2 text-left text-xs font-semibold text-gray-600 border-b border-r border-gray-200 bg-gray-50">
                  Company
                ...
                <th class="px-4 py-2 text-left text-xs font-semibold text-gray-600 border-b border-gray-200 bg-gray-50">
                  Status
                </th>
              </tr>
            </thead>
...
function AuthAnimation() {
  ...
  return (
    <div
      ...
      class="auth-anim-scale-wrapper relative overflow-hidden rounded-2xl w-full h-full"
    >
      ...
      >
        ...
        <div class="absolute top-16 left-0 right-0 z-50 flex justify-center">
          <span
            class="text-[24px] font-bold text-black animate-[blur-in_0.6s_ease-out]"
        ...
        <div class="absolute top-5 left-5 z-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <button
            class="relative w-7 h-7 rounded-full bg-white/15 backdrop-blur-sm hover:scale-105 transition-all duration-200 flex items-center justify-center"
            onClick={handleTogglePlay}
          >
            <svg class="absolute inset-0 -rotate-90" viewBox="0 0 28 28">
              <circle
                cx="14"
                cy="14"
                r="13"
