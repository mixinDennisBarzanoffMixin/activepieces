          ...
          >
            {!readonly && (
              <PieceSelector
                ...
                id={id}
                openSelectorOnClick={!isShowingDropIndicator}
              >
                <div
                  style={{
                    height: `${flowCanvasConsts.AP_NODE_SIZE.STEP.height}px`,
                ...
                >
                  <div className="bg-builder-background rounded-lg">
                    <div
                      style={{
                        height: `${flowCanvasConsts.AP_NODE_SIZE.BIG_ADD_BUTTON.height}px`,
                        width: `${flowCanvasConsts.AP_NODE_SIZE.BIG_ADD_BUTTON.width}px`,
                      }}
                      className="border-none flex cursor-pointer items-center justify-center relative"
                    >
                      <div
                        style={{
                          height: `${flowCanvasConsts.AP_NODE_SIZE.BIG_ADD_BUTTON.height}px`,
                      ...
                      >
                        {!isShowingDropIndicator && (
                          <span>
                            <Button
                              variant="transparent"
                              className="w-full h-full flex cursor-pointer items-center rounded-lg border-border border-solid border"
                            >
                              <Plus
                                className={cn('w-6 h-6 text-foreground', {
                                  'opacity-0': isPieceSelectorOpened,
                                })}
                              />
                            </Button>
                          </span>
                        ...
                        <div
                          style={{
                            ...
                            top: `-${
                              ...
                              flowCanvasConsts.AP_NODE_SIZE.BIG_ADD_BUTTON
                                .width /
                                2
                            }px`,
                          }}
