...
const ShowPoweredBy = (_props: ShowPoweredByProps) => {
  const props = mergeProps({ position: 'sticky' as const }, _props);
  return (
    <Show when={props.show}>
      <div
        class={cn(
          ...
          props.position,
          {
            '-mt-[30px]': props.position === 'sticky',
            'mr-5': props.position === 'sticky',
          },
        )}
      >
        <div
          class={cn(
            ...
            {
              'justify-center': props.position === 'static',
            },
          )}
        >
          <div class=" text-sm transition">Built with</div>
          <div class="justify-center flex items-center gap-1">
            <svg
              ...
              viewBox="0 0 24 24"
              class="transition fill-muted-foreground/70"
            >
            ...
            <div class="font-semibold">activepieces</div>
          </div>
        </div>
      </div>
    </Show>
